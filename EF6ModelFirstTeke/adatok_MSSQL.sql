...
(45, 'Wiener Neustadt'), 
(46, 'Zalaegerszeg am.');
SET IDENTITY_INSERT Egyesuletek OFF;

SET IDENTITY_INSERT Versenyzok ON;
INSERT INTO Versenyzok(Rajtszam, Nev, EgyesuletId, Korcsop) VALUES
...
SET IDENTITY_INSERT Versenyzok OFF;

SET IDENTITY_INSERT Eredmenyek ON;
INSERT INTO Eredmenyek(Sorsz, VersenyzoRajtszam, Teli, Tarolas, Ures) VALUES
(1, 1, 86, 45, 0),
(2, 1, 90, 34, 2),
(3, 1, 87, 36, 3),
(4, 1, 97, 54, 0),
...
(189, 60, 85, 45, 1),
(190, 60, 91, 45, 1);
SET IDENTITY_INSERT Eredmenyek OFF;
